...
<header class="header">
   ...
   <a class="logo"><img src="img/123.jpg" alt="logo" width="10%"></a>
   </div>
        <div class="col-md-12 text-center">
...
<section id="aboutus">
 ...
 <div class="container">
   <h3 class="text-center"><br><br>খাবো কি ?</h3>
   <div class="row">
<!--carousel-->
...
<!--end of carousel-->
	...
	<p><br>The খাবো কি ?, first opened in 2020 in “Dhaka”.<br><br><br></p><hr>
	</div>
     </div>
    </div><br>
  </div>
...
<section class="map" id="footer">
    ...
    <h3 class="text-center"><br><br>Find us!</h3><br>
        <iframe src="https://www.google.com/maps/embed?23.7681316,90.3550443,17z" style= "width:100%;  height:250px; border:0;" allowfullscreen></iframe>
...
?>
            ...
            <p class="text-right">খাবো কি ?<br><i class="fa fa-map-marker"></i>&nbsp; Mohammadpur-1207, <br>Dhaka <br><br>email: marufon21@gmail.com<br>phone: 01845004124</p>
            </div>
